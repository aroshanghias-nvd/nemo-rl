...
# INPUT_PATH = "/lustre/fsw/portfolios/llmservice/users/ikarmanov/rl_datasets/super_clevr/super_clevr_train.jsonl"
INPUT_PATH = "super_clevr_train_shuffled.jsonl"
INPUT_SIZE = 50000
...
**Task**: Answer compositional questions about vehicle scenes. You need to analyze visual properties, spatial relationships, and part-level attributes.

**Dataset**: Synthetic 3D scenes of vehicles with attributes like color, material, and shape.

**Requirements**:
1. Before answering, explicitly identify all objects in the scene
2. Describe the visual attributes you observe (color, size, material, shape)
3. Note spatial relationships (left/right, front/behind, near/far)
4. When applicable, reference specific vehicle parts (wheels, doors, wings, etc.)
5. Chain your observations logically to arrive at the answer

Ground every reasoning step in what you actually see. Do not guess, if something is ambiguous or occluded, acknowledge it.
""".strip()
